...
![skokadoさん](./images/skokado.jpg)

- タイトル: モノリスDjangoにおける堅牢性の追求
- 経歴: 2022年より株式会社RevCommにてPythonを使ったWebアプリケーションのバックエンド開発、
およびAWSクラウドの運用やプラットフォームエンジニアリングに従事。
